; ModuleID = 'circuit-831'
source_filename = "circuit-831"

%Qubit = type opaque
%Result = type opaque

define void @circuit-831() #0 {
entry:
  ...
  call void @__quantum__qis__ry__body(double 0x3FE28F5C28F5C291, %Qubit* inttoptr (i64 2 to %Qubit*))
  call void @__quantum__qis__cnot__body(%Qubit* inttoptr (i64 2 to %Qubit*), %Qubit* inttoptr (i64 1 to %Qubit*))
  call void @__quantum__qis__h__body(%Qubit* inttoptr (i64 1 to %Qubit*))
  call void @__quantum__qis__cnot__body(%Qubit* null, %Qubit* inttoptr (i64 1 to %Qubit*))
  call void @__quantum__qis__h__body(%Qubit* null)
  call void @__quantum__qis__ry__body(double 0xC00134D4B45F8730, %Qubit* inttoptr (i64 2 to %Qubit*))
