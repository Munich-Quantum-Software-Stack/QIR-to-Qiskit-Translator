; ModuleID = 'circuit-224'
source_filename = "circuit-224"

%Qubit = type opaque
%Result = type opaque

define void @circuit-224() #0 {
entry:
  call void @__quantum__rt__initialize(i8* null)
  call void @__quantum__qis__h__body(%Qubit* null)
  call void @__quantum__qis__rx__body(double 0x3FE921FB54442D16, %Qubit* inttoptr (i64 1 to %Qubit*))
  ...
  call void @__quantum__qis__rx__body(double 0x3FE921FB54442D1C, %Qubit* inttoptr (i64 2 to %Qubit*))
  call void @__quantum__qis__rx__body(double 0x3FE921FB54442D16, %Qubit* inttoptr (i64 3 to %Qubit*))
  ...
  call void @__quantum__qis__rx__body(double 0x3FE921FB54442D18, %Qubit* inttoptr (i64 3 to %Qubit*))
