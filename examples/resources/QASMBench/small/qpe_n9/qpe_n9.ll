; ModuleID = 'circuit-262'
source_filename = "circuit-262"

%Qubit = type opaque
%Result = type opaque

define void @circuit-262() #0 {
entry:
  ...
  call void @__quantum__qis__ccx__body(%Qubit* inttoptr (i64 5 to %Qubit*), %Qubit* inttoptr (i64 6 to %Qubit*), %Qubit* inttoptr (i64 7 to %Qubit*))
