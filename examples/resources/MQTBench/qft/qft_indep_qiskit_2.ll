; ModuleID = 'circuit-400944'
source_filename = "circuit-400944"

%Qubit = type opaque
%Result = type opaque

define void @circuit-400944() #0 {
entry:
...
attributes #0 = { "entry_point" "num_required_qubits"="2" "num_required_results"="4" "output_labeling_schema" "qir_profiles"="custom" }
