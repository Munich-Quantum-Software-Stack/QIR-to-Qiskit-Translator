; ModuleID = 'circuit-572538'
source_filename = "circuit-572538"

%Qubit = type opaque
%Result = type opaque

define void @circuit-572538() #0 {
entry:
  ...
  call void @__quantum__qis__ry__body(double 0x3FEDAC670561BB4F, %Qubit* inttoptr (i64 4 to %Qubit*))
  call void @__quantum__qis__cnot__body(%Qubit* null, %Qubit* inttoptr (i64 4 to %Qubit*))
  call void @__quantum__qis__ry__body(double 0xBFEDAC670561BB52, %Qubit* inttoptr (i64 4 to %Qubit*))
  call void @__quantum__qis__cnot__body(%Qubit* null, %Qubit* inttoptr (i64 4 to %Qubit*))
  call void @__quantum__qis__ry__body(double 0x3FEDAC670561BB4F, %Qubit* inttoptr (i64 4 to %Qubit*))
  ...
  call void @__quantum__qis__ry__body(double 0xBFFDAC670561BB50, %Qubit* inttoptr (i64 4 to %Qubit*))
  call void @__quantum__qis__cnot__body(%Qubit* inttoptr (i64 1 to %Qubit*), %Qubit* inttoptr (i64 4 to %Qubit*))
  call void @__quantum__qis__ry__body(double 0x3FFDAC670561BB50, %Qubit* inttoptr (i64 4 to %Qubit*))
  ...
  call void @__quantum__qis__ry__body(double 0x4004978FA3269EE1, %Qubit* inttoptr (i64 4 to %Qubit*))
  call void @__quantum__qis__cnot__body(%Qubit* inttoptr (i64 2 to %Qubit*), %Qubit* inttoptr (i64 4 to %Qubit*))
  call void @__quantum__qis__ry__body(double 0xC004978FA3269EE2, %Qubit* inttoptr (i64 4 to %Qubit*))
  ...
  call void @__quantum__qis__ry__body(double 0xBFF229AEC47638DB, %Qubit* inttoptr (i64 4 to %Qubit*))
  call void @__quantum__qis__cnot__body(%Qubit* inttoptr (i64 3 to %Qubit*), %Qubit* inttoptr (i64 4 to %Qubit*))
  call void @__quantum__qis__ry__body(double 0x3FF229AEC47638DD, %Qubit* inttoptr (i64 4 to %Qubit*))
