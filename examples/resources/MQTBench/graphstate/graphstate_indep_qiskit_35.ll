; ModuleID = 'circuit-152519'
source_filename = "circuit-152519"

%Qubit = type opaque
%Result = type opaque

define void @circuit-152519() #0 {
entry:
  ...
  call void @__quantum__qis__cz__body(%Qubit* inttoptr (i64 1 to %Qubit*), %Qubit* inttoptr (i64 18 to %Qubit*))
  ...
  call void @__quantum__qis__cz__body(%Qubit* inttoptr (i64 13 to %Qubit*), %Qubit* inttoptr (i64 21 to %Qubit*))
  ...
  call void @__quantum__qis__cz__body(%Qubit* inttoptr (i64 19 to %Qubit*), %Qubit* inttoptr (i64 28 to %Qubit*))
