; ModuleID = 'circuit-152462'
source_filename = "circuit-152462"

%Qubit = type opaque
%Result = type opaque

define void @circuit-152462() #0 {
entry:
  ...
  call void @__quantum__qis__cz__body(%Qubit* inttoptr (i64 11 to %Qubit*), %Qubit* inttoptr (i64 34 to %Qubit*))
