; ModuleID = 'circuit-152399'
source_filename = "circuit-152399"

%Qubit = type opaque
%Result = type opaque

define void @circuit-152399() #0 {
entry:
  ...
  call void @__quantum__qis__cz__body(%Qubit* inttoptr (i64 9 to %Qubit*), %Qubit* inttoptr (i64 26 to %Qubit*))
  ...
  call void @__quantum__qis__cz__body(%Qubit* inttoptr (i64 1 to %Qubit*), %Qubit* inttoptr (i64 29 to %Qubit*))
  ...
  call void @__quantum__qis__cz__body(%Qubit* inttoptr (i64 30 to %Qubit*), %Qubit* inttoptr (i64 33 to %Qubit*))
