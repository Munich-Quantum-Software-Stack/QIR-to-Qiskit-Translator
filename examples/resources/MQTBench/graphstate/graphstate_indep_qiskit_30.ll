; ModuleID = 'circuit-50987'
source_filename = "circuit-50987"

%Qubit = type opaque
%Result = type opaque

define void @circuit-50987() #0 {
entry:
  ...
  call void @__quantum__qis__cz__body(%Qubit* inttoptr (i64 11 to %Qubit*), %Qubit* inttoptr (i64 24 to %Qubit*))
  ...
  call void @__quantum__qis__cz__body(%Qubit* inttoptr (i64 25 to %Qubit*), %Qubit* inttoptr (i64 27 to %Qubit*))
