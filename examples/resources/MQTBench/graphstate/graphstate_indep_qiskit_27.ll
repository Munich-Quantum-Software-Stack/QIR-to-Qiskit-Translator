; ModuleID = 'circuit-869121'
source_filename = "circuit-869121"

%Qubit = type opaque
%Result = type opaque

define void @circuit-869121() #0 {
entry:
  ...
  call void @__quantum__qis__cz__body(%Qubit* inttoptr (i64 8 to %Qubit*), %Qubit* inttoptr (i64 20 to %Qubit*))
