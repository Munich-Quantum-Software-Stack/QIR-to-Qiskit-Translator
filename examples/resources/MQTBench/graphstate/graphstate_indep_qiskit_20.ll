; ModuleID = 'circuit-152411'
source_filename = "circuit-152411"

%Qubit = type opaque
%Result = type opaque

define void @circuit-152411() #0 {
entry:
  ...
  call void @__quantum__qis__cz__body(%Qubit* inttoptr (i64 1 to %Qubit*), %Qubit* inttoptr (i64 19 to %Qubit*))
