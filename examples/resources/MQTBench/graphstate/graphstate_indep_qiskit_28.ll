; ModuleID = 'circuit-152612'
source_filename = "circuit-152612"

%Qubit = type opaque
%Result = type opaque

define void @circuit-152612() #0 {
entry:
  ...
  call void @__quantum__qis__cz__body(%Qubit* inttoptr (i64 17 to %Qubit*), %Qubit* inttoptr (i64 25 to %Qubit*))
  ...
  call void @__quantum__qis__cz__body(%Qubit* inttoptr (i64 9 to %Qubit*), %Qubit* inttoptr (i64 27 to %Qubit*))
