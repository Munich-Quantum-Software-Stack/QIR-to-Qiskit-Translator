; ModuleID = 'circuit-152648'
source_filename = "circuit-152648"

%Qubit = type opaque
%Result = type opaque

define void @circuit-152648() #0 {
entry:
  ...
  call void @__quantum__qis__cz__body(%Qubit* inttoptr (i64 31 to %Qubit*), %Qubit* inttoptr (i64 34 to %Qubit*))
  ...
  call void @__quantum__qis__cz__body(%Qubit* inttoptr (i64 12 to %Qubit*), %Qubit* inttoptr (i64 38 to %Qubit*))
