; ModuleID = 'circuit-152663'
source_filename = "circuit-152663"

%Qubit = type opaque
%Result = type opaque

define void @circuit-152663() #0 {
entry:
  ...
  call void @__quantum__qis__cz__body(%Qubit* inttoptr (i64 11 to %Qubit*), %Qubit* inttoptr (i64 19 to %Qubit*))
