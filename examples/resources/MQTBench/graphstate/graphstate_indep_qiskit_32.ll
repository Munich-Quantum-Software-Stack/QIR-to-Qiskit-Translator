; ModuleID = 'circuit-152594'
source_filename = "circuit-152594"

%Qubit = type opaque
%Result = type opaque

define void @circuit-152594() #0 {
entry:
  ...
  call void @__quantum__qis__cz__body(%Qubit* inttoptr (i64 11 to %Qubit*), %Qubit* inttoptr (i64 21 to %Qubit*))
  ...
  call void @__quantum__qis__cz__body(%Qubit* inttoptr (i64 16 to %Qubit*), %Qubit* inttoptr (i64 30 to %Qubit*))
  call void @__quantum__qis__cz__body(%Qubit* inttoptr (i64 25 to %Qubit*), %Qubit* inttoptr (i64 30 to %Qubit*))
  call void @__quantum__qis__h__body(%Qubit* inttoptr (i64 31 to %Qubit*))
  call void @__quantum__qis__cz__body(%Qubit* inttoptr (i64 2 to %Qubit*), %Qubit* inttoptr (i64 31 to %Qubit*))
  call void @__quantum__qis__cz__body(%Qubit* inttoptr (i64 17 to %Qubit*), %Qubit* inttoptr (i64 31 to %Qubit*))
