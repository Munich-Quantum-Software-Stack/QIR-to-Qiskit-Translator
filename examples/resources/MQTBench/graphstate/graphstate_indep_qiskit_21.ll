; ModuleID = 'circuit-152417'
source_filename = "circuit-152417"

%Qubit = type opaque
%Result = type opaque

define void @circuit-152417() #0 {
entry:
  ...
  call void @__quantum__qis__cz__body(%Qubit* inttoptr (i64 17 to %Qubit*), %Qubit* inttoptr (i64 19 to %Qubit*))
