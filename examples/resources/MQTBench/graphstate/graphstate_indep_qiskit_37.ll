; ModuleID = 'circuit-152435'
source_filename = "circuit-152435"

%Qubit = type opaque
%Result = type opaque

define void @circuit-152435() #0 {
entry:
  ...
  call void @__quantum__qis__cz__body(%Qubit* inttoptr (i64 1 to %Qubit*), %Qubit* inttoptr (i64 28 to %Qubit*))
  ...
  call void @__quantum__qis__cz__body(%Qubit* inttoptr (i64 7 to %Qubit*), %Qubit* inttoptr (i64 36 to %Qubit*))
  call void @__quantum__qis__cz__body(%Qubit* inttoptr (i64 14 to %Qubit*), %Qubit* inttoptr (i64 36 to %Qubit*))
