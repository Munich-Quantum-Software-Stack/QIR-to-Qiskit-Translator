; ModuleID = 'circuit-152633'
source_filename = "circuit-152633"

%Qubit = type opaque
%Result = type opaque

define void @circuit-152633() #0 {
entry:
  ...
  call void @__quantum__qis__cz__body(%Qubit* inttoptr (i64 8 to %Qubit*), %Qubit* inttoptr (i64 19 to %Qubit*))
  ...
  call void @__quantum__qis__cz__body(%Qubit* null, %Qubit* inttoptr (i64 20 to %Qubit*))
