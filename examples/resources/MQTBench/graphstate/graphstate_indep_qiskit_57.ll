; ModuleID = 'circuit-1119449'
source_filename = "circuit-1119449"

%Qubit = type opaque
%Result = type opaque

define void @circuit-1119449() #0 {
entry:
  ...
  call void @__quantum__qis__cz__body(%Qubit* inttoptr (i64 10 to %Qubit*), %Qubit* inttoptr (i64 25 to %Qubit*))
  ...
  call void @__quantum__qis__cz__body(%Qubit* inttoptr (i64 12 to %Qubit*), %Qubit* inttoptr (i64 44 to %Qubit*))
  call void @__quantum__qis__cz__body(%Qubit* inttoptr (i64 33 to %Qubit*), %Qubit* inttoptr (i64 44 to %Qubit*))
  ...
  call void @__quantum__qis__cz__body(%Qubit* inttoptr (i64 15 to %Qubit*), %Qubit* inttoptr (i64 45 to %Qubit*))
  ...
  call void @__quantum__qis__cz__body(%Qubit* null, %Qubit* inttoptr (i64 55 to %Qubit*))
