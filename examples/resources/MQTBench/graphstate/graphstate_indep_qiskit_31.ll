; ModuleID = 'circuit-986180'
source_filename = "circuit-986180"

%Qubit = type opaque
%Result = type opaque

define void @circuit-986180() #0 {
entry:
  ...
  call void @__quantum__qis__cz__body(%Qubit* inttoptr (i64 8 to %Qubit*), %Qubit* inttoptr (i64 18 to %Qubit*))
  ...
  call void @__quantum__qis__cz__body(%Qubit* inttoptr (i64 25 to %Qubit*), %Qubit* inttoptr (i64 29 to %Qubit*))
