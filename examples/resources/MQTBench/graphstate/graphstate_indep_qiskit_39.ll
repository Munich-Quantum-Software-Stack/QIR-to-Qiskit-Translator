; ModuleID = 'circuit-152549'
source_filename = "circuit-152549"

%Qubit = type opaque
%Result = type opaque

define void @circuit-152549() #0 {
entry:
  ...
  call void @__quantum__qis__cz__body(%Qubit* inttoptr (i64 13 to %Qubit*), %Qubit* inttoptr (i64 24 to %Qubit*))
  ...
  call void @__quantum__qis__cz__body(%Qubit* inttoptr (i64 6 to %Qubit*), %Qubit* inttoptr (i64 27 to %Qubit*))
  ...
  call void @__quantum__qis__cz__body(%Qubit* inttoptr (i64 14 to %Qubit*), %Qubit* inttoptr (i64 29 to %Qubit*))
  ...
  call void @__quantum__qis__cz__body(%Qubit* inttoptr (i64 32 to %Qubit*), %Qubit* inttoptr (i64 36 to %Qubit*))
  ...
  call void @__quantum__qis__cz__body(%Qubit* inttoptr (i64 35 to %Qubit*), %Qubit* inttoptr (i64 38 to %Qubit*))
