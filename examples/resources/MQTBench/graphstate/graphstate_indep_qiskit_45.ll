; ModuleID = 'circuit-152597'
source_filename = "circuit-152597"

%Qubit = type opaque
%Result = type opaque

define void @circuit-152597() #0 {
entry:
  ...
  call void @__quantum__qis__cz__body(%Qubit* inttoptr (i64 26 to %Qubit*), %Qubit* inttoptr (i64 34 to %Qubit*))
  ...
  call void @__quantum__qis__cz__body(%Qubit* inttoptr (i64 10 to %Qubit*), %Qubit* inttoptr (i64 40 to %Qubit*))
