; ModuleID = 'circuit-152492'
source_filename = "circuit-152492"

%Qubit = type opaque
%Result = type opaque

define void @circuit-152492() #0 {
entry:
  ...
  call void @__quantum__qis__cz__body(%Qubit* inttoptr (i64 2 to %Qubit*), %Qubit* inttoptr (i64 22 to %Qubit*))
  ...
  call void @__quantum__qis__cz__body(%Qubit* inttoptr (i64 3 to %Qubit*), %Qubit* inttoptr (i64 37 to %Qubit*))
  call void @__quantum__qis__cz__body(%Qubit* inttoptr (i64 31 to %Qubit*), %Qubit* inttoptr (i64 37 to %Qubit*))
