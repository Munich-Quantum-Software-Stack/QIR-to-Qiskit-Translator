; ModuleID = 'circuit-152513'
source_filename = "circuit-152513"

%Qubit = type opaque
%Result = type opaque

define void @circuit-152513() #0 {
entry:
  ...
  call void @__quantum__qis__cz__body(%Qubit* inttoptr (i64 6 to %Qubit*), %Qubit* inttoptr (i64 33 to %Qubit*))
