; ModuleID = 'circuit-1252316'
source_filename = "circuit-1252316"

%Qubit = type opaque
%Result = type opaque

define void @circuit-1252316() #0 {
entry:
  ...
  call void @__quantum__qis__cz__body(%Qubit* inttoptr (i64 8 to %Qubit*), %Qubit* inttoptr (i64 26 to %Qubit*))
  ...
  call void @__quantum__qis__cz__body(%Qubit* inttoptr (i64 29 to %Qubit*), %Qubit* inttoptr (i64 35 to %Qubit*))
  ...
  call void @__quantum__qis__cz__body(%Qubit* inttoptr (i64 20 to %Qubit*), %Qubit* inttoptr (i64 36 to %Qubit*))
  ...
  call void @__quantum__qis__cz__body(%Qubit* inttoptr (i64 25 to %Qubit*), %Qubit* inttoptr (i64 40 to %Qubit*))
