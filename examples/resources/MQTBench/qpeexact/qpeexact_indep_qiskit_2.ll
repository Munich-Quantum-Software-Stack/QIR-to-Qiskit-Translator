; ModuleID = 'circuit-795351'
source_filename = "circuit-795351"

%Qubit = type opaque
%Result = type opaque

define void @circuit-795351() #0 {
entry:
...
attributes #0 = { "entry_point" "num_required_qubits"="2" "num_required_results"="1" "output_labeling_schema" "qir_profiles"="custom" }
