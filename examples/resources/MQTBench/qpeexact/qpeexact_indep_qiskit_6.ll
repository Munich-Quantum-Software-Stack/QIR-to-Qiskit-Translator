; ModuleID = 'circuit-1007624'
source_filename = "circuit-1007624"

%Qubit = type opaque
%Result = type opaque

define void @circuit-1007624() #0 {
entry:
  ...
  call void @__quantum__qis__rz__body(double 0xBFF5FDBBE9BBA775, %Qubit* inttoptr (i64 5 to %Qubit*))
