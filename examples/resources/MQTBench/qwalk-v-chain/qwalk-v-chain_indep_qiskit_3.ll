; ModuleID = 'circuit-346460'
source_filename = "circuit-346460"

%Qubit = type opaque
%Result = type opaque

define void @circuit-346460() #0 {
entry:
  call void @__quantum__rt__initialize(i8* null)
  call void @__quantum__qis__h__body(%Qubit* inttoptr (i64 2 to %Qubit*))
  call void @__quantum__qis__ccx__body(%Qubit* inttoptr (i64 2 to %Qubit*), %Qubit* inttoptr (i64 1 to %Qubit*), %Qubit* null)
