; ModuleID = 'circuit-572268'
source_filename = "circuit-572268"

%Qubit = type opaque
%Result = type opaque

define void @circuit-572268() #0 {
entry:
  ...
  call void @__quantum__qis__rz__body(double 0xBFF59933FC6A96C1, %Qubit* inttoptr (i64 6 to %Qubit*))
  ...
  call void @__quantum__qis__cnot__body(%Qubit* inttoptr (i64 6 to %Qubit*), %Qubit* null)
  call void @__quantum__qis__rz__body(double 0x3FDC463ABECCB2BB, %Qubit* inttoptr (i64 6 to %Qubit*))
  ...
  call void @__quantum__qis__cnot__body(%Qubit* inttoptr (i64 6 to %Qubit*), %Qubit* inttoptr (i64 1 to %Qubit*))
  call void @__quantum__qis__rz__body(double 0x3FEC463ABECCB2BB, %Qubit* inttoptr (i64 6 to %Qubit*))
