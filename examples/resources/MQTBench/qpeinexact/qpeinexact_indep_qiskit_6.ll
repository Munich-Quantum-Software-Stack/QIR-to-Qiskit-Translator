; ModuleID = 'circuit-1252288'
source_filename = "circuit-1252288"

%Qubit = type opaque
%Result = type opaque

define void @circuit-1252288() #0 {
entry:
  ...
  call void @__quantum__qis__rz__body(double 0x3FF534AC0F19860C, %Qubit* inttoptr (i64 5 to %Qubit*))
  call void @__quantum__qis__cnot__body(%Qubit* inttoptr (i64 5 to %Qubit*), %Qubit* null)
  call void @__quantum__qis__rz__body(double 0xBFF534AC0F19860C, %Qubit* null)
  call void @__quantum__qis__cnot__body(%Qubit* inttoptr (i64 5 to %Qubit*), %Qubit* null)
  call void @__quantum__qis__rz__body(double 0xBFDF6A7A2955385E, %Qubit* inttoptr (i64 5 to %Qubit*))
  call void @__quantum__qis__cnot__body(%Qubit* inttoptr (i64 5 to %Qubit*), %Qubit* inttoptr (i64 1 to %Qubit*))
  call void @__quantum__qis__rz__body(double 0x3FF534AC0F19860C, %Qubit* null)
  call void @__quantum__qis__rz__body(double 0x3FDF6A7A2955385E, %Qubit* inttoptr (i64 1 to %Qubit*))
  call void @__quantum__qis__cnot__body(%Qubit* inttoptr (i64 5 to %Qubit*), %Qubit* inttoptr (i64 1 to %Qubit*))
  ...
  call void @__quantum__qis__rz__body(double 0xBFDF6A7A2955385E, %Qubit* inttoptr (i64 1 to %Qubit*))
  call void @__quantum__qis__rz__body(double 0x3FEF6A7A2955385E, %Qubit* inttoptr (i64 2 to %Qubit*))
  call void @__quantum__qis__cnot__body(%Qubit* inttoptr (i64 5 to %Qubit*), %Qubit* inttoptr (i64 2 to %Qubit*))
  ...
  call void @__quantum__qis__rz__body(double 0xBFF2D97C7F3321D2, %Qubit* inttoptr (i64 3 to %Qubit*))
  call void @__quantum__qis__cnot__body(%Qubit* inttoptr (i64 5 to %Qubit*), %Qubit* inttoptr (i64 3 to %Qubit*))
  ...
  call void @__quantum__qis__rz__body(double 0x3FF2D97C7F3321D2, %Qubit* inttoptr (i64 3 to %Qubit*))
