; ModuleID = 'circuit-1029288'
source_filename = "circuit-1029288"

%Qubit = type opaque
%Result = type opaque

define void @circuit-1029288() #0 {
entry:
...
attributes #0 = { "entry_point" "num_required_qubits"="13" "num_required_results"="12" "output_labeling_schema" "qir_profiles"="custom" }
