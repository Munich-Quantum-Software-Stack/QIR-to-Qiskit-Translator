; ModuleID = 'circuit-1027390'
source_filename = "circuit-1027390"

%Qubit = type opaque
%Result = type opaque

define void @circuit-1027390() #0 {
entry:
...
attributes #0 = { "entry_point" "num_required_qubits"="15" "num_required_results"="14" "output_labeling_schema" "qir_profiles"="custom" }
