; ModuleID = 'circuit-1028954'
source_filename = "circuit-1028954"

%Qubit = type opaque
%Result = type opaque

define void @circuit-1028954() #0 {
entry:
...
attributes #0 = { "entry_point" "num_required_qubits"="12" "num_required_results"="11" "output_labeling_schema" "qir_profiles"="custom" }
