; ModuleID = 'circuit-656149'
source_filename = "circuit-656149"

%Qubit = type opaque
%Result = type opaque

define void @circuit-656149() #0 {
entry:
...
attributes #0 = { "entry_point" "num_required_qubits"="11" "num_required_results"="10" "output_labeling_schema" "qir_profiles"="custom" }
